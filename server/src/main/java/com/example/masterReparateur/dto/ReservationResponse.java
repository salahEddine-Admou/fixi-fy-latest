...
public class ReservationResponse {
    ...
    public ReservationResponse(Reservation reservation) {
        ...
        this.reparateur = reservation.getReparation().getRepairer() != null ?
            reservation.getReparation().getRepairer().getFirstName() + " " + reservation.getReparation().getRepairer().getLastName() : null;
        ...
        if (reservation.getSupportTechnique() != null) {
            this.support = reservation.getSupportTechnique().getFirstName() + " " + reservation.getSupportTechnique().getLastName();
        }

        this.success = reservation.isSuccess();
        this.repAddress = reservation.getReparation().getRepairer() != null ? reservation.getReparation().getRepairer().getAddress() : null;
        this.deliveries = reservation.getDeliveries();
        this.invoices = reservation.getInvoices().stream()
        ...
        this.probleme = reservation.getReparation().getProblem() != null ? reservation.getReparation().getProblem().getName() : null;
        ...
        this.repPhoneNumber = reservation.getReparation().getRepairer() != null ? reservation.getReparation().getRepairer().getPhone() : null;
        if (reservation.getOldRepairer() != null) {
            this.oldrepAddress = reservation.getOldRepairer().getAddress();
            this.oldReparateur = reservation.getOldRepairer().getFirstName() + " " + reservation.getOldRepairer().getLastName();
