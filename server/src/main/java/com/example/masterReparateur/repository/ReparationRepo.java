...
public interface ReparationRepo extends JpaRepository<Reparation, Long> {
    ...
    List<Reparation> findAllByModelIdAndRepairerUsername(@Param("modelId") Long modelId, @Param("username") String username);


    Optional<Reparation> findByModelIdAndProblemIdAndRepairerUsername(Long modelId, Long problemId,
            String username);
