...
public class SubcategoryModelService {
    ...
    public List<SubCategoryResponse> getAllSubCategories() {
        ...
        List<SubCategoryResponse> subCategories = subCategories$.stream()
                .map(this::mapToDto)
    ...
    public void deleteSubCategory(Long id) {
        ...
        throw new MasterException("Cette marque a des réservations, vous ne pouvez pas le supprimer.", HttpStatus.NOT_FOUND);
    }
