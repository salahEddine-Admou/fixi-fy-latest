        ...
        private void sendEmails(String clientEmail, String repairerEmail, Reservation reservation) {
                ...
                for (Livreur livreur : livreurs) {
                        mailService.sendMail(new NotificationEmail("Nouvelle reservation a livrer", livreur.getEmail(),
                                        "Une nouvelle reservaton pour vous a livrer : http://fixi-fy.com/front/new-reservation/"
                ...
                for (Admin supportTechnique : supportTechniques) {
                        mailService.sendMail(
                                        new NotificationEmail("Nouvelle reservation est met en place",
                                                        ...
                                                        "Une nouvelle reservaton est met en place : http://fixi-fy.com/front/new-reservation/"
                                                                        + reservation.getId()));
                }
                mailService.sendMail(new NotificationEmail("Nouvelle reservation pour vous", repairerEmail,
                                "Une nouvelle reservaton pour vous : http://fixi-fy.com/front/new-reservation/"
                                                + reservation.getId()));

                mailService.sendMail(new NotificationEmail("Votre reservation est affecte  a un autre reparateur ",
                                clientEmail,
                                "Votre reservation est affecte  a un autre reparateur : http://fixi-fy.com/front/new-reservation/"
                                                + reservation.getId()));
        }
