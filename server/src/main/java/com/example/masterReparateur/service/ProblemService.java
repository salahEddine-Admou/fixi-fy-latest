...
public class ProblemService {
    ...
    public List<ProblemTypeResponse> getAllProblems() {
        ...
        List<ProblemTypeResponse> problems = problems$.stream()
                .map(this::mapToDto)
    ...
    public void deleteProblem(Long id) {
        ...
        throw new MasterException("Ce Problème a des réservations, vous ne pouvez pas le supprimer.", HttpStatus.NOT_FOUND);
    }
    ...
    public void createPrice(PriceCSVDto priceDto) {
        ...
        Optional<Reparation> reparationOptional = reparationRepo.findByModelIdAndProblemIdAndRepairerUsername(
                model.getId(),
                problem.getId(), priceDto.getUsername());
    ...
    public void createPrices(PriceRequest priceDto) {
        ...
        for (int i = 0; i < priceDto.getPrices().size(); i++) {
            ...
            Optional<Reparation> priceOptional = reparationRepo.findByModelIdAndProblemIdAndRepairerUsername(
                    priceDto.getModelId(),
                    problemId, priceDto.getUsername());
    ...
    public PriceResponse getProblemPrice(Long modelId, Long problemId, Long repairerId) {
        Reparation reparation = reparationRepo
                .findByModelIdAndProblemIdAndRepairerId(modelId, problemId, repairerId).get();
