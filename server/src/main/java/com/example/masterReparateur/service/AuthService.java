...
public class AuthService {
    ...
    public void signup(RegisterRequest registerRequest) {
        ...
        mailService.sendMail(new NotificationEmail("Please activate ur acount", client.getEmail(),
                "Click to this link to activate ur email: http://fixi-fy.com/auth/accountverification/"
                        + token));
    ...
    public void emailPassword(Long id){
        ...
        if(optionalUser.isPresent()){
            ...
            mailService.sendMail(new NotificationEmail("Changer mot de passe", user.getEmail(),
                "Pour changer le mot de passe de votre compts clique sur ce lien : http://fixi-fy.com/front/changePassword/"
                    + user.getId()));
        }else{
