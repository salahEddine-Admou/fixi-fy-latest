...
public class ImageUploadController {
    ...
    public ImageUploadController(CinPhotoRepo cinPhotoRepo, PortfolioRepo portfolioRepo, RepairerRepo repairerRepo, RepairerService repairerService,ImageReservationRepo imageReservationRepo) {
